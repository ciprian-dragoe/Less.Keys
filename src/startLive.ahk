...
#include %A_ScriptDir%\app\environmentDependent\shortcuts\live\indexShortcuts.ahk
#include %A_ScriptDir%\app\debug\debug.ahk
#include %A_ScriptDir%\app\environmentDependent\postStartup\live\postStartup.ahk
...
#include %A_ScriptDir%\app\environmentDependent\keyHooks\live\keyHooks.ahk

; if you want to add your custom labels, add them here  
#include %A_ScriptDir%\app\environmentDependent\labels\live\custom.ahk