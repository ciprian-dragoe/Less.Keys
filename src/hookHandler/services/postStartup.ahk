...
onMessage(APP_MESSAGE_IS_ANY_MODIFIER_KEY_PRESSED_HANDLE, "handleModifierKeyPressed")
onMessage(APP_MESSAGE_IS_NOT_ANY_MODIFIER_KEY_PRESSED_HANDLE, "handleModifierKeyNotPressed")
